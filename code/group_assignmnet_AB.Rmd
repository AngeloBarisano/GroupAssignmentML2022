...
```{r}
# # lump country together 
# forcats::fct_lump(bookings_train)
# 
# 
# bookings_train["country"] <- forcats::fct_lump(
#   c("country"),
#   3,
#   other_level = "Other",
...
recipe_prelim <- recipe(is_cancelled ~ ., data = bookings_train_train) |> 
  ...
  update_role("assigned_room_type", "arrival_date_year", new_role = "metadata") |> 
